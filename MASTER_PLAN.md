...
- **Broken doc link fixes: SHIPPED.** Fixed 10 broken markdown links in `docs/WHATS_NEW.md` and `docs/USER_GUIDE_MULTI_STEP_CONTAINERS.md` referencing deleted `implementation-history/` and `plans/` files (PR #5143).
