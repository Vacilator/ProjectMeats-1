...
- **2026-04-28** — [COMPLETED] Hard-bound AI chat sessions, chat messages, manual document uploads, and Graph attachment session reuse to `request.tenant` via session tenant context, making the multi-tenant AI session APIs fail closed for ambiguous or cross-tenant access. (PR: TBD)
