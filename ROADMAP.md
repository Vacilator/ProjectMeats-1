...
- The next frontend operator simplification pass is now tracked canonically as **Phase 36** in `MASTER_PLAN.md` + `.github/EPIC_TICKETS.md`; use that lane for Command Center four-section compression and execution drill-in cleanup instead of extending historical Cockpit/process-monitor notes here.
