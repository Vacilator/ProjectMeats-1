...
AI_CHAT_COMPACTION_TAIL_MESSAGES = int(os.environ.get("AI_CHAT_COMPACTION_TAIL_MESSAGES", "12"))
AI_CHAT_COMPACTION_MAX_SUMMARY_CHARS = int(os.environ.get("AI_CHAT_COMPACTION_MAX_SUMMARY_CHARS", "2400"))
