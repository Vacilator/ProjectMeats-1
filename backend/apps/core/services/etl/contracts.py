...
ENTITY_CONTRACTS: dict[str, EntityContract] = {
    "locations": EntityContract(
        ...
        canonical_fields=("name", "address", "city", "state_zip", "country", "plant_est_number"),
        field_groups=("contact_snapshot",),
        natural_keys=("name", "city", "state_zip"),
        notes=("Legacy warehouse, delivery, pickup, and plant rows normalize into Location.",),
    ),
    "plants": EntityContract(
        entity="plants",
        phase="master_data",
        target_model="tenant_apps.locations.models.Location",
        canonical_fields=("name", "plant_est_number", "type_of_plant"),
        field_groups=("contact_snapshot",),
        depends_on=("locations",),
        natural_keys=("name", "plant_est_number"),
        notes=(
            "Legacy plant worksheets map into plant-typed Location rows.",
            "If legacy SupplierPlant joins exist, preserve them as follow-on relationships after Location creation.",
        ),
    ),
    ...
    "contacts": EntityContract(
        ...
        canonical_fields=("name", "email", "phone", "title", "department"),
        depends_on=("suppliers", "customers", "carriers", "locations"),
        natural_keys=("email", "phone", "name"),
