...
class ThrottleConfigurationTestCase(TestCase):
    ...
    def test_anon_rate_is_restrictive(self):
        ...
        self.assertLess(anon_rate, user_rate, 
            "Anonymous rate should be lower than user rate")
    ...
    def test_auth_rate_is_most_restrictive(self):
        ...
        self.assertLess(auth_rate, anon_rate,
            "Auth rate should be lower than anon rate (stricter)")
