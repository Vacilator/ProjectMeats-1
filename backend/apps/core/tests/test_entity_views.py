...
class EntityRegistryTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # Create tenant
        self.tenant = Tenant.objects.create(name="Test Tenant", slug="test-tenant", schema_name="test_tenant")
    ...
    def test_entity_registry_tenant_isolation(self):
        ...
        tenant2 = Tenant.objects.create(name="Another Tenant", slug="another-tenant", schema_name="another_tenant")
        ...
        TenantUser.objects.create(user=user2, tenant=tenant2, role="admin", is_active=True)
...
class EntitySchemaTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # Create tenant
        self.tenant = Tenant.objects.create(name="Test Tenant", slug="test-tenant", schema_name="public")
...
class EntityLookupTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # Create tenant
        self.tenant = Tenant.objects.create(name="Test Tenant", slug="test-tenant", schema_name="test_tenant_lookup")
...
class EntityPermissionsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        TenantUser.objects.create(user=self.regular_user, tenant=self.tenant, role="user", is_active=True)
