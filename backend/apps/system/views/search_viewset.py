    ...
    def _search_customers(self, query: str, tenant, limit: int, results: list, counts: dict):
        ...
        try:
            ...
            for customer in customers:
                score = EntityRanking.calculate_total_score(query=query, entity_type="customer", entity=customer)
                ...
                results.append(
                    {
                        ...
                        "subtitle": f"{customer.city}, {customer.state}"
                        if customer.city and customer.state
                        else customer.email or "",
                        "icon": "👤",
                        "color": "rgb(59, 130, 246)",
    ...
    def _search_suppliers(self, query: str, tenant, limit: int, results: list, counts: dict):
        ...
        try:
            ...
            for supplier in suppliers:
                score = EntityRanking.calculate_total_score(query=query, entity_type="supplier", entity=supplier)
                ...
                results.append(
                    {
                        ...
                        "subtitle": f"{supplier.city}, {supplier.state}"
                        if supplier.city and supplier.state
                        else supplier.email or "",
                        "icon": "🏢",
    ...
    def _search_purchase_orders(self, query: str, tenant, limit: int, results: list, counts: dict):
        ...
        try:
            ...
            pos_qs = (
                ...
                .filter(Q(order_number__icontains=query) | Q(our_purchase_order_num__icontains=query))
    ...
    def _search_sales_orders(self, query: str, tenant, limit: int, results: list, counts: dict):
        ...
        try:
            ...
            sos_qs = (
                ...
                .filter(Q(order_number__icontains=query))
