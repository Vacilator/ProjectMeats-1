...
MEAT_INDUSTRY_CHOICE_LISTS = [
    ...
    },
    {
        ...
        "items": [
            ...
            {"value": "SELECT", "label": "Select", "order": 30, "extra_data": {"description": "Leaner, less marbling"}},
            {
                "value": "STANDARD",
                "label": "Standard",
                "order": 40,
    ...
    },
    {
        ...
        "is_reorderable": True,
        "items": [
            {"value": "PRIMAL", "label": "Primal", "order": 10, "extra_data": {"description": "Large wholesale cuts"}},
            {
                "value": "SUBPRIMAL",
                "label": "Subprimal",
                "order": 20,
            ...
            {"value": "RETAIL", "label": "Retail", "order": 30, "extra_data": {"description": "Consumer-ready cuts"}},
            {"value": "GROUND", "label": "Ground", "order": 40, "extra_data": {"description": "Ground or minced meat"}},
            {
