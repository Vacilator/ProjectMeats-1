...
class ConfigResolver:
    ...
    def get_choices(
        ...
        include_tenant_custom: bool = True
    ) -> List[Dict[str, Any]]:
        """
        ...
        if include_tenant_custom and self.tenant_id:
            ...
            items_query = items_query.filter(
                Q(tenant__isnull=True) | Q(tenant_id=self.tenant_id)
            )
        else:
            # System items only
    ...
    def set_tenant_config(self, key: str, value: Any, category: str = 'OTHER', description: str = '', user=None) -> TenantConfig:
        """
