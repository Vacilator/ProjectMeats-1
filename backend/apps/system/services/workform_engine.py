...
class WorkFormEngine:
        ...
        while current_id:
            ...
            if visited_guard > 5000:
                return ExecutionResult(
                    success=False, context=self.context, error="Traversal guard tripped (possible cycle)"
                )
    ...
    def _append_audit_event(
        self, event: str, *, node_id: Optional[str] = None, node_type: Optional[str] = None, **meta
    ) -> None:
