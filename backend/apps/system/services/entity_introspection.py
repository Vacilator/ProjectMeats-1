...
ENTITY_ID_ALIASES = {
    ...
    "carrier_po": "purchase_orders.carrierpurchaseorder",
    "carrier-pos": "purchase_orders.carrierpurchaseorder",
    "freight_order": "purchase_orders.carrierpurchaseorder",
    "freight-orders": "purchase_orders.carrierpurchaseorder",
    ...
    for app_label in app_labels:
        try:
            ...
            for model in app_config.get_models():
                ...
                field_count = len([f for f in model._meta.get_fields() if not f.auto_created or f.concrete])
...
def get_entity_fields(entity_id: str):
    ...
    for field in model._meta.get_fields():
        ...
        if isinstance(field, models.CharField):
            ...
            # Extract choices
            field_data["choices"] = [{"value": choice[0], "label": choice[1]} for choice in field.choices]
