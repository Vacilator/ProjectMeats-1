...
class EntityRanking:
    ...
    def score_value_customer(customer) -> int:
        ...
        try:
            ...
            total_orders = customer.sales_orders.aggregate(
    ...
    def score_value_supplier(supplier) -> int:
        ...
        try:
            ...
            total_purchases = supplier.purchase_orders.aggregate(
                total=Sum('total_amount')
            )['total'] or 0
    ...
    def calculate_total_score(
        ...
        entity_type: str,
        entity: Any,
        last_activity_date: Optional[timezone.datetime] = None
    ) -> int:
        """
...
class EntityLabels:
    ...
    def _supplier_labels(supplier) -> List[Dict[str, str]]:
        ...
        try:
            active_pos = supplier.purchase_orders.filter(
