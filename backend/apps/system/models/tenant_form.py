...
class TenantForm(models.Model):
    ...
    name = models.CharField(
        max_length=255,
        help_text="Form name/title"
    )
    description = models.TextField(
        blank=True,
        help_text="Optional form description"
    )
    ...
    form_definition = models.JSONField(
        default=dict,
        help_text="Form structure: entity type, fields, validation"
    )
    
    # Versioning
    version = models.IntegerField(
        default=1,
        help_text="Form version number (auto-incremented on update)"
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name='unique_tenant_form_name_version'
            )
        ]
