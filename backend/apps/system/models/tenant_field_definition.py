...
class TenantFieldDefinition(models.Model):
    ...
    model_name = models.CharField(
        max_length=100, help_text="Model identifier (e.g., 'suppliers.Supplier', 'products.Product')"
    )
    ...
    field_type = models.CharField(
        max_length=20, choices=FieldTypeChoices.choices, help_text="Type of field (text, select, date, etc.)"
    )

    label = models.CharField(max_length=255, help_text="Display label for the field (e.g., 'Halal Certified')")
    ...
    is_active = models.BooleanField(default=True, help_text="Whether this field is currently active/visible")

    # Display order
    display_order = models.PositiveIntegerField(default=0, help_text="Order in which custom fields are displayed")
