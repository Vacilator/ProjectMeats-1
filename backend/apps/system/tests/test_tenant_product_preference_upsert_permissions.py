...
class TenantProductPreferenceUpsertPermissionTests(TestCase):
    ...
    def test_regular_user_cannot_create_preference(self):
        ...
        request = factory.post('/api/v1/system/product-preferences/', {'product': str(self.product.id), 'is_active': False}, format='json')
    ...
    def test_admin_user_can_upsert_preference(self):
        ...
        request1 = factory.post('/api/v1/system/product-preferences/', {'product': str(self.product.id), 'is_active': False}, format='json')
        ...
        request2 = factory.post('/api/v1/system/product-preferences/', {'product': str(self.product.id), 'is_active': True}, format='json')
