        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_reorderable",
                    models.BooleanField(
                        default=True, help_text="Whether items can be reordered"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "help_text",
                    models.TextField(
                        blank=True, help_text="Help text shown below the field"
                    ),
                ),
                (
                    "placeholder",
                ...
                (
                    "default_value",
                    models.JSONField(
                        blank=True, help_text="Default value for new records", null=True
                    ),
                ),
                (
                    "is_required",
                ...
                (
                    "is_readonly",
                    models.BooleanField(
                        default=False, help_text="Whether this field is read-only"
                    ),
                ),
                (
                    "is_hidden",
                    models.BooleanField(
                        default=False, help_text="Whether this field is hidden from UI"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Description of what this config controls"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant", "key"), name="unique_tenant_config_key"
                    )
                ],
            },
        ),
