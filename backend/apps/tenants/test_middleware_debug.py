...
class TenantMiddlewareDebugLoggingTests(TestCase):
    ...
    def setUp(self):
        ...
        # Create test tenant
        self.tenant = Tenant.objects.create(name="Test Tenant", slug="test", contact_email="test@example.com")
    ...
    def test_middleware_works_without_debug_domains(self):
        ...
        TenantDomain.objects.create(domain="example.com", tenant=self.tenant, is_primary=True)
    ...
    def test_middleware_works_with_staging_domain(self):
        ...
        TenantDomain.objects.create(domain="staging.meatscentral.com", tenant=self.tenant, is_primary=True)
    ...
    def test_middleware_logs_tenant_resolution_failure(self):
        ...
        request = self.factory.get("/", HTTP_HOST="staging.meatscentral.com")
        request.user = User.objects.create_user(username="notenantuser", email="notenant@example.com")
    ...
    def test_middleware_works_with_uat_domain(self):
        ...
        TenantDomain.objects.create(domain="uat.meatscentral.com", tenant=self.tenant, is_primary=True)
