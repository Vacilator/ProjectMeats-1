...
class DocumentOperationsAPITests(APITestCase):
    ...
    @patch(
        "tenant_apps.purchase_orders.services.approval_dispatch._resolve_recipient",
        return_value=("", ""),
    )
    def test_purchase_order_approval_fails_closed_without_supplier_email(self, _mock_resolve):
