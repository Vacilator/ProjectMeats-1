...
class FulfillmentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identification", {"fields": ("tenant", "fulfillment_number", "inquiry", "status")}),
        ("Parties", {"fields": ("supplier", "customer", "carrier")}),
        ("Logistics", {"fields": ("ship_date", "expected_delivery", "actual_delivery", "tracking_numbers")}),
        ("Totals", {"fields": ("total_value",)}),
        ("Notes", {"fields": ("notes",), "classes": ("collapse",)}),
        ("Metadata", {"fields": ("created_by", "shipped_by", "created_on", "modified_on"), "classes": ("collapse",)}),
    )
    ...
    def get_queryset(self, request):
        ...
        return (
            ...
            .select_related("tenant", "inquiry", "supplier", "customer", "carrier", "created_by", "shipped_by")
        )
