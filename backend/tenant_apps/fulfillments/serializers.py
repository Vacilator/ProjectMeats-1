...
class FulfillmentProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'inquiry_product', 'product_code', 'product_description',
            'inquiry_quantity', 'quantity_fulfilled', 'unit_price', 'total',
...
class FulfillmentDetailSerializer(TradeTimelineSerializerMixin, serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = [
            'id', 'fulfillment_number', 'created_on', 'modified_on',
            'total_value', 'is_partial'
        ]
...
class ShipFulfillmentSerializer(serializers.Serializer):
    ...
    tracking_numbers = serializers.ListField(
        ...
        required=False,
        help_text="Tracking numbers to add"
    )
    ship_date = serializers.DateField(
        required=False,
        help_text="Ship date (defaults to today)"
    )
