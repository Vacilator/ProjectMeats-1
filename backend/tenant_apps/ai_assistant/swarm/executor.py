...
DEFAULT_OPENAI_TOOLS = [
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "has_attachments": {
                        "type": "boolean",
                        "description": (
                            "Optional attachment filter. Omit to include both messages " "with and without attachments."
                        ),
                    },
                    "search_query": {
                        "type": "string",
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "entity_type": {
                        "type": "string",
                        "description": "Entity type (supplier, customer, purchase_order, ...)",
                    },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "type": {
                        "type": "string",
                        "description": "Entity type (supplier, customer, product, purchase_order, ...)",
                    },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "notification_type": {
                        "type": "string",
                        "description": "NotificationType value (task_assigned, mention, system, ...)",
                    },
                    "priority": {
                        "type": "string",
                        "description": "NotificationPriority value (low, normal, high, urgent)",
                    },
                    "entity_type": {"type": "string", "description": "Optional related entity type"},
                    "entity_id": {"type": "string", "description": "Optional related entity id"},
                    ...
                    "to_tenant_admins": {
                        "type": "boolean",
                        "description": "If true, notify all active tenant owners/admins",
                    },
                    "user_id": {"type": "string", "description": "Optional recipient user id"},
                    "user_ids": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "Optional recipient user ids",
                    },
                    "username": {"type": "string", "description": "Optional recipient username"},
                    "usernames": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "Optional recipient usernames",
                    },
                },
                "required": ["title", "message"],
                "additionalProperties": False,
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "user_message": {
                        "type": "string",
                        "description": "The user message being corrected (optional but recommended).",
                    },
                    "assistant_message": {
                        "type": "string",
                        "description": "The assistant message being corrected (optional but recommended).",
                    },
                    "user_correction": {
                        "type": "string",
                        "description": "What the user says is the correct information.",
                    },
                    "lesson_text": {
                        "type": "string",
                        "description": "Canonical lesson to remember and apply in future answers.",
                    },
                    "entity_type": {
                        "type": "string",
                        "description": (
                            "Optional entity type the lesson applies to "
                            "(purchase_order, supplier, customer, product, ...)."
                        ),
                    },
            ...
            "parameters": {
                ...
                "properties": {
                    "entity_type": {
                        "type": "string",
                        "description": (
                            "Entity type or alias (e.g., supplier, " "customers.customer, purchase_order, plant)."
                        ),
                    },
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "entity_type": {
                        "type": "string",
                        "description": "Entity type or alias (e.g., supplier, customer, plant, location, contact).",
                    },
    ...
    },
    {
        ...
        "function": {
            "name": "parse_document",
            "description": (
                "Parse an uploaded AI document (by document_id) via " "Unstructured API and return extracted text."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "file_id_or_url": {
                        "type": "string",
                        "description": "AIDocument UUID (preferred). URL is not supported for SSRF safety.",
                    },
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "order_number": {
                        "type": "string",
                        "description": "PO number (maps to PurchaseOrder.order_number).",
                    },
                    "supplier_id": {"type": "string", "description": "Supplier ID (maps to PurchaseOrder.supplier)."},
                    "product_id": {
                        "type": "string",
                        "description": "Optional system.Product id (maps to PurchaseOrder.product).",
                    },
                    ...
                    "order_date": {
                        "type": "string",
                        "description": "Optional order date (YYYY-MM-DD). Defaults to today.",
                    },
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "End-to-end PO ingestion: parse document, extract fields, " "create missing supplier, and draft a PO."
            ),
            "parameters": {
                "type": "object",
                "properties": {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "context": {
                        "type": "string",
                        "description": "Context for the email (issue, discrepancy, request, etc.)",
                    },
    ...
    },
    {
        ...
        "function": {
            "name": "create_record",
            "description": (
                "Create a tenant-scoped record (limited to safe entity types). " "(Legacy tool; prefer create_entity.)"
            ),
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Run a tenant-scoped analytics aggregation (e.g., top purchased " "products, revenue by customer)."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "entity_type": {
                        "type": "string",
                        "description": (
                            "Entity type to analyze (product, customer, supplier, " "purchase_order, sales_order)."
                        ),
                    },
                    "metric": {
                        "type": "string",
                        "description": (
                            "Metric key (top_purchased_products, revenue_by_customer, "
                            "top_suppliers_by_po_value, purchase_order_trends)."
                        ),
                    },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "entity_type": {
                        "type": "string",
                        "description": "Entity type (customer, supplier, purchase_order, etc.)",
                    },
...
class ToolExecutor:
    ...
    def execute(
        ...
        try:
            ...
            if (
                session_id
                and tool_name in {"fetch_emails", "ingest_email_attachment", "check_unread_emails"}
                and not safe_args.get("session_id")
            ):
    ...
    def _create_entity(self, arguments: Dict[str, Any], tenant: Any, user: Any = None) -> Any:
        ...
        if not entity_key:
            ...
            entity_key = (
                raw_entity_type
                if raw_entity_type
                in {"supplier", "customer", "contact", "plant", "location", "purchase_order", "sales_order", "invoice"}
                else None
            )
    ...
    def _parse_document(self, arguments: Dict[str, Any], tenant: Any, user: Any = None) -> Any:
        ...
        if document_uuid is None:
            try:
                ...
                raise ValueError(
                    "parse_document requires an uploaded document_id (UUID or integer). "
                    "URL fetch is disabled for SSRF safety."
                ) from e
            ...
            try:
                ...
                if isinstance(parsed, dict):
                    ...
                    if items and isinstance(items[0], dict):
                        item0 = items[0]
                        item_description = (
                            str(item0.get("description") or item_description or "").strip() or item_description
                        )
    ...
    def _create_product(self, arguments: Dict[str, Any], tenant: Any, user: Any = None) -> Any:
        ...
        if not (getattr(user, "is_staff", False) or getattr(user, "is_superuser", False)):
            return {
                ...
                "message": (
                    "Creating Tier-1 catalog products requires a staff user. " "Proceeding without product linkage."
                ),
                "name": name,
            }
        ...
        req = factory.post(
            ...
            {"name": name, "product_code": product_code, "protein_type": protein_type},
            format="json",
        )
        force_authenticate(req, user=user)
        req.tenant = tenant
    ...
    def _create_in_app_notification(self, arguments: Dict[str, Any], tenant: Any, user: Any = None) -> Any:
        ...
        if user_id:
            ids = list(
                TenantUser.objects.filter(tenant=tenant, is_active=True, user_id=user_id).values_list(
                    "user_id", flat=True
                )
            )
        ...
        if username:
            ids = list(
                TenantUser.objects.filter(tenant=tenant, is_active=True, user__username=username).values_list(
                    "user_id", flat=True
                )
            )
            recipients.extend(list(User.objects.filter(id__in=ids)))
        ...
        if user_ids:
            ids = list(
                TenantUser.objects.filter(tenant=tenant, is_active=True, user_id__in=user_ids).values_list(
                    "user_id", flat=True
                )
            )
            recipients.extend(list(User.objects.filter(id__in=ids)))
        ...
        if usernames:
            ids = list(
                TenantUser.objects.filter(tenant=tenant, is_active=True, user__username__in=usernames).values_list(
                    "user_id", flat=True
                )
            )
            recipients.extend(list(User.objects.filter(id__in=ids)))
