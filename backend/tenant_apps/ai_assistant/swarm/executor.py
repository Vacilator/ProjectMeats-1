        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "entity_type": {
                        "type": "string",
                        "description": "Optional entity type the lesson applies to (purchase_order, supplier, customer, product, ...).",
                    },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "entity_type": {
                        "type": "string",
                        "description": "Entity type or alias (e.g., supplier, customers.customer, purchase_order, plant).",
                    },
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "entity_type": {
                        "type": "string",
                        "description": "Entity type to analyze (product, customer, supplier, purchase_order, sales_order).",
                    },
                    "metric": {
                        "type": "string",
                        "description": "Metric key (top_purchased_products, revenue_by_customer, top_suppliers_by_po_value, purchase_order_trends).",
                    },
