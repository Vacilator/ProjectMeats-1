...
class PendingReviewView(APIView):
    ...
    - Non-staff users: always returns an empty queue (safe default).
    - Staff users: returns a real pending-review queue backed by AIFeedbackLog.

    This preserves the widget contract while enabling HITL workflows for admins.
    """
