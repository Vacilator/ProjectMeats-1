...
class Location(TenantAwareModel):
    ...
    state = models.CharField(max_length=50, blank=True, default="", help_text="State or province")
    zip_code = models.CharField(max_length=20, blank=True, default="", help_text="ZIP or postal code")
    country = models.CharField(max_length=100, blank=True, default="USA", help_text="Country")

    # Contact information
    phone = models.CharField(max_length=20, blank=True, default="", help_text="Location phone number")
    ...
    email = models.EmailField(blank=True, default="", help_text="Location email address")
    contact_name = models.CharField(max_length=255, blank=True, default="", help_text="Contact person name")
    ...
    manager = models.CharField(max_length=100, blank=True, default="", help_text="Plant manager name")
    capacity = models.PositiveIntegerField(null=True, blank=True, help_text="Capacity in units (for plants)")
    ...
    legacy_plant_id = models.PositiveIntegerField(
        null=True, blank=True, db_index=True, help_text="Original Plant ID before migration (for reference)"
    )
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.UniqueConstraint(
                fields=["tenant", "code"], condition=models.Q(code__gt=""), name="unique_location_code_per_tenant"
            ),
        ]
    ...
    def get_plant_type_choices(cls):
        ...
        return [(choice.value, choice.label) for choice in LocationTypeChoices if choice.value.startswith("plant_")]
