# Generated by Django 6.0 on 2026-05-07 11:52

import django.db.models.deletion
from django.conf import settings
from django.db import migrations, models

import tenant_apps.sales_orders.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name="SalesOrderApprovalDispatch",
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        default="",
                        upload_to=tenant_apps.sales_orders.models.sales_order_approval_dispatch_upload_to,
                    ),
                ),
        ...
        migrations.RunSQL(
            sql="""
            ALTER TABLE sales_orders_salesorderapprovaldispatch ENABLE ROW LEVEL SECURITY;
            CREATE POLICY salesorderapprovaldispatch_tenant_isolation
                ON sales_orders_salesorderapprovaldispatch
                USING (tenant_id = current_setting('app.current_tenant')::uuid);
            """,
            reverse_sql="""
            DROP POLICY IF EXISTS salesorderapprovaldispatch_tenant_isolation
                ON sales_orders_salesorderapprovaldispatch;
            ALTER TABLE sales_orders_salesorderapprovaldispatch DISABLE ROW LEVEL SECURITY;
            """,
        ),
    ]
