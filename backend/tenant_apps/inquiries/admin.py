...
from .models import Inquiry, InquiryProduct, InquirySupplierRFQ, InquiryTemplate, InquiryTemplateProduct, TradeSession
...
class InquiryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identification", {"fields": ("tenant", "inquiry_number", "status", "source_type", "source_call")}),
        ("Entity", {"fields": ("entity_type", "supplier", "customer", "contact")}),
        (
            "Contact Snapshot",
            {
        ...
        ("Dates", {"fields": ("inquiry_date", "quoted_date", "decision_date", "valid_until")}),
        (
            "Totals (Calculated)",
            {
        ...
        ("Metadata", {"fields": ("created_by", "created_on", "modified_on"), "classes": ("collapse",)}),
    )
    ...
    def get_queryset(self, request):
        ...
        return (
            ...
            .select_related("tenant", "supplier", "customer", "contact", "source_call", "created_by")
        )
...
class InquiryTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Template Info", {"fields": ("tenant", "name", "description", "entity_type", "is_active")}),
        ("Defaults", {"fields": ("default_valid_days", "default_notes")}),
        ("Usage", {"fields": ("use_count",), "classes": ("collapse",)}),
        ("Metadata", {"fields": ("created_by", "created_on", "modified_on"), "classes": ("collapse",)}),
    )
