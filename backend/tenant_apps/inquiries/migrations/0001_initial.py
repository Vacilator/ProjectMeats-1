...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quoted_date",
                    models.DateTimeField(
                        blank=True, help_text="When the quote was provided", null=True
                    ),
                ),
                (
                    "decision_date",
                ...
                (
                    "valid_until",
                    models.DateField(
                        blank=True, help_text="Quote expiration date", null=True
                    ),
                ),
                (
                    "notes",
                ...
                (
                    ...
                    models.TextField(
                        blank=True, default="", help_text="Intel on competitor pricing"
                    ),
                ),
                (
                    "win_loss_reason",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        blank=True, help_text="Expected processing date", null=True
                    ),
                ),
                (
                    "desired_expiration_date",
                    models.DateField(
                        blank=True, help_text="Expected expiration date", null=True
                    ),
                ),
                (
                    "desired_available_date",
                    models.DateField(
                        blank=True, help_text="When needed/available", null=True
                    ),
                ),
                (
                    "desired_shipping_date",
                    models.DateField(
                        blank=True, help_text="Expected ship date", null=True
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DateField(
                        blank=True, help_text="Actual processing date", null=True
                    ),
                ),
                (
                    "actual_expiration_date",
                    models.DateField(
                        blank=True, help_text="Actual expiration date", null=True
                    ),
                ),
                (
                    "actual_available_date",
                    models.DateField(
                        blank=True, help_text="Actual availability date", null=True
                    ),
                ),
                (
                    "actual_shipping_date",
                    models.DateField(
                        blank=True, help_text="Actual ship date", null=True
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            model_name="inquiry",
            index=models.Index(
                fields=["tenant", "status"], name="inquiries_i_tenant__c7fc7c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="inquiry",
            index=models.Index(
                fields=["tenant", "entity_type"], name="inquiries_i_tenant__e92a12_idx"
            ),
        ),
    ]
