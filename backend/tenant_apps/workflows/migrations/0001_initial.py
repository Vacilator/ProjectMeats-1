        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.PositiveIntegerField(
                        default=0, help_text="Order in which rules are evaluated"
                    ),
                ),
                (
                    "conditions",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="When this workflow last ran", null=True
                    ),
                ),
                (
                    "run_count",
                    models.PositiveIntegerField(
                        default=0, help_text="Number of times this workflow has run"
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.PositiveIntegerField(
                        default=0, help_text="Order in which actions are executed"
                    ),
                ),
                (
                    "continue_on_error",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "compare_value",
                    models.JSONField(
                        blank=True, help_text="Value to compare against", null=True
                    ),
                ),
                (
                    "order",
                    models.PositiveIntegerField(
                        default=0, help_text="Order of condition evaluation"
                    ),
                ),
                (
                    "workflow",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "trigger_type",
                    models.CharField(
                        help_text="What triggered this execution", max_length=30
                    ),
                ),
                (
                    "trigger_data",
                ...
                (
                    "actions_executed",
                    models.PositiveIntegerField(
                        default=0, help_text="Number of actions executed"
                    ),
                ),
                (
                    "actions_failed",
                    models.PositiveIntegerField(
                        default=0, help_text="Number of actions that failed"
                    ),
                ),
                (
                    "error_message",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "field_key",
                    models.CharField(
                        help_text="Field key/name from the entity model", max_length=100
                    ),
                ),
                (
                    "is_visible",
                ...
                (
                    "is_required",
                    models.BooleanField(
                        default=False, help_text="Override: make this field required"
                    ),
                ),
                (
                    "order",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the option list", max_length=255
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        blank=True, default="", help_text="Description of the list"
                    ),
                ),
                (
                    "options",
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether this list is active"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
