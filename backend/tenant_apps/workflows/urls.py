...
from .views import (  # Admin Form Builder API Views; Form Submission API Views; Entity Options API Views; Form Import/Export API Views; Form Analytics API Views; Form Test Data API Views; Wave 3: Forms & Flows Enhancement Views; Phase 4.2: Permission System; AI suggestions
    ActionItemCountsAPIView,
    ActionItemsAPIView,
    AvailableEntitiesAPIView,
    AvailableFormsViewSet,
    EntityFieldsAPIView,
    EntityOptionsAPIView,
    FieldConfigAPIView,
    FieldMappingAPIView,
    FieldTemplatesAPIView,
    FormAnalyticsAPIView,
    FormAutoMapAPIView,
    FormDuplicateAPIView,
    FormEventAPIView,
    FormExportAPIView,
    FormImportAPIView,
    FormMappingsAPIView,
    FormRuleDetailAPIView,
    FormRulesAPIView,
    FormStatusHistoryViewSet,
    FormStepDetailAPIView,
    FormStepFieldsAPIView,
    FormStepReorderAPIView,
    FormStepsAPIView,
    FormSubmissionViewSet,
    FormTestDataAPIView,
    QuickActionsAPIView,
    QuickCreateEntityAPIView,
    SmartFieldMatchAPIView,
    StepAssignmentViewSet,
    SuggestNodesView,
    TenantFormEntityViewSet,
    TenantFormFieldViewSet,
    TenantFormRuleViewSet,
    TenantFormViewSet,
    TenantListViewSet,
    TenantWorkflowActionViewSet,
    TenantWorkflowConditionViewSet,
...
from .views_triggers import ManualTriggerAPIView, WebhookReceiverAPIView, WorkflowWebhookAPIView
...
urlpatterns = [
    ...
    path(
        "form-submissions/<uuid:submission_id>/history/",
