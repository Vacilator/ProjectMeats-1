...
class FieldInheritanceService:
    ...
    TYPE_VALIDATION_RULES = {
        "text": {"type": "string", "required_keys": [], "optional_keys": ["min_length", "max_length", "pattern"]},
        "email": {
            "type": "string",
            "required_keys": [],
        ...
        "number": {"type": "number", "required_keys": [], "optional_keys": ["min", "max", "step"]},
        "integer": {"type": "integer", "required_keys": [], "optional_keys": ["min", "max", "step"]},
        "date": {"type": "string", "required_keys": [], "optional_keys": ["min_date", "max_date"], "format": "date"},
        "datetime": {
            "type": "string",
            "required_keys": [],
        ...
        "boolean": {"type": "boolean", "required_keys": [], "optional_keys": []},
        "select": {"type": "string", "required_keys": ["options"], "optional_keys": []},
        "multiselect": {"type": "array", "required_keys": ["options"], "optional_keys": ["min_items", "max_items"]},
        "textarea": {"type": "string", "required_keys": [], "optional_keys": ["min_length", "max_length"]},
        "file": {
            "type": "string",
            "required_keys": [],
    ...
    def compute_inherited_validation(field: TenantFormField) -> Dict[str, Any]:
        ...
        if hasattr(django_field, "choices") and django_field.choices:
            validation["options"] = [{"value": value, "label": label} for value, label in django_field.choices]

        return validation

    @staticmethod
    def validate_field_value(field: TenantFormField, value: Any) -> Dict[str, Any]:
        """
        ...
        # Get type schema
        type_schema = FieldInheritanceService.TYPE_VALIDATION_RULES.get(field.field_type, {})

        # Merge validation rules: computed + manual + type schema
        all_rules = {**field.computed_validation, **field.validation_rules}
    ...
    def get_effective_validation(field: TenantFormField) -> Dict[str, Any]:
        ...
        """
        return {**field.computed_validation, **field.validation_rules}
