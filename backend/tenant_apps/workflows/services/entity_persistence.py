...
class EntityPersistenceService:
    ...
    def resolve_foreign_key(self, field_key: str, value: Any, step_data: Dict) -> Any:
        ...
        if field_key.endswith("_id"):
            ...
            if model_class:
                try:
                    return model_class.objects.get(pk=value, tenant=self.tenant)
    ...
    def prepare_entity_data(self, entity_type: str, step_data: Dict[str, Any], model_class) -> Dict[str, Any]:
        """
        ...
        """
        entity_data = {"tenant": self.tenant}
    ...
    def persist_all(self) -> Dict[str, Any]:
        ...
        """
        result = {"success": True, "created_entities": {}, "errors": [], "partial": False}
