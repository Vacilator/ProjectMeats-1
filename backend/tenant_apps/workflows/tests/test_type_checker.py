...
from tenant_apps.workflows.services.type_checker import TypeChecker, ValidationError, validate_workflow_data
...
class TypeCheckerTestCase(TestCase):
    ...
    def test_datetime_parsing(self):
        ...
        checker = TypeChecker([{"name": "created_at", "type": "datetime", "required": False}])
    ...
    def test_number_type_multiple_acceptable(self):
        ...
        checker = TypeChecker([{"name": "amount", "type": "number", "required": False}])
