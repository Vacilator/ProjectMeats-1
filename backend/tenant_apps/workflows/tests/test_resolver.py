...
from tenant_apps.workflows.services.resolver import VariableResolver, resolve_action_config, resolve_variables
...
class TestVariableResolver(unittest.TestCase):
    ...
    def test_nested_object_access(self):
        ...
        context = {"customer": {"name": "John", "email": "john@example.com", "address": {"city": "New York"}}}
    ...
    def test_array_indexing(self):
        ...
        context = {"items": ["apple", "banana", "cherry"], "users": [{"name": "Alice"}, {"name": "Bob"}]}
        resolver = VariableResolver(context)
...
class TestConvenienceFunctions(unittest.TestCase):
    ...
    def test_resolve_variables_function(self):
        ...
        result = resolve_variables("Hello {{ name }}, welcome to {{ city }}!", {"name": "Alice", "city": "NYC"})
    ...
    def test_resolve_action_config(self):
        ...
        context = {"customer": {"name": "John", "email": "john@example.com"}, "order": {"id": "12345"}}
    ...
    def test_resolve_action_config_selective(self):
        ...
        context = {"template": {"id": "tmpl-001", "description": "Default Template"}}

        # Only resolve specific fields
        result = resolve_action_config(config, context, fields_to_resolve=["template_id", "description"])
