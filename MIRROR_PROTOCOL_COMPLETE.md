...
- **Legacy detail-page drift**: fixed by standardizing routed plant/location/contact pages on header-first detail views with modal edit instead of inline form walls.
