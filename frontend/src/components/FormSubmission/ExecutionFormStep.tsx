...
export const ExecutionFormStep: React.FC<ExecutionFormStepProps> = ({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- granular deps: context.data and context.resolve are intentional; using full context would cause infinite re-renders
