...
export const CreateFulfillmentModal: React.FC<CreateFulfillmentModalProps> = ({
  ...
  const fetchSuppliers = async (productIds: string[]) => {
    ...
    try {
      ...
      logger.error('Failed to fetch suppliers', { component: 'CreateFulfillmentModal' }, err);
      setSupplierOptions([]);
    } finally {
  ...
  const fetchCarriers = async () => {
    ...
    try {
      ...
      logger.error('Failed to fetch carriers', { component: 'CreateFulfillmentModal' }, err);
      setCarrierOptions([]);
    } finally {
  ...
  const handleSubmit = form.handleSubmit(async (values) => {
    ...
    try {
      ...
      logger.error('Failed to create fulfillment', { component: 'CreateFulfillmentModal' }, err);
