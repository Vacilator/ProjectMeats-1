...
const INQUIRY_CONFIG: EntityWorkflowConfig = {
  ...
  transitions: {
    [t('draft', 'quoted')]: { label: 'Send Quote', intent: 'primary', description: 'Record that a price quote has been sent to the customer. This is the first step.' },
    [t('draft', 'cancelled')]: { label: 'Cancel', intent: 'danger', confirm: 'Cancel this inquiry?' },
    [t('pending', 'quoted')]: { label: 'Send Quote', intent: 'primary', description: 'Record that a price quote has been sent to the customer' },
    [t('pending', 'cancelled')]: { label: 'Cancel', intent: 'danger', confirm: 'Cancel this inquiry?' },
    [t('quoted', 'accepted')]: { label: 'Accept Deal', intent: 'success', description: 'Customer accepted — a Purchase Order will be auto-created', confirm: 'Accept this inquiry? A draft Purchase Order will be created automatically.' },
    ...
    [t('accepted', 'fulfilled')]: { label: 'Mark Fulfilled', intent: 'success', description: 'Mark this inquiry as fully fulfilled — all deliveries complete' },
