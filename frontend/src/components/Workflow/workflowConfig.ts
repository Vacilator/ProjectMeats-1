...
const PURCHASE_ORDER_CONFIG: EntityWorkflowConfig = {
  ...
  transitions: {
    ...
    [t('pending', 'pending_approval')]: { label: 'Submit for Approval', intent: 'primary' },
    ...
    [t('approved', 'sent')]: { label: 'Send to Supplier', intent: 'primary' },
    [t('approved', 'carrier_assigned')]: { label: 'Assign Carrier', intent: 'primary' },
...
const SALES_ORDER_CONFIG: EntityWorkflowConfig = {
  ...
  transitions: {
    ...
    [t('pending_approval', 'approved')]: { label: 'Approve', intent: 'success' },
    [t('pending_approval', 'cancelled')]: { label: 'Reject', intent: 'danger' },
    [t('approved', 'confirmed')]: { label: 'Confirm Order', intent: 'primary' },
...
const CARRIER_PO_CONFIG: EntityWorkflowConfig = {
  ...
  transitions: {
    ...
    [t('pending_approval', 'approved')]: { label: 'Approve', intent: 'success' },
    [t('pending_approval', 'cancelled')]: { label: 'Reject', intent: 'danger' },
    [t('approved', 'dispatched')]: { label: 'Dispatch', intent: 'primary' },
    [t('approved', 'cancelled')]: { label: 'Cancel', intent: 'danger' },
...
const FULFILLMENT_CONFIG: EntityWorkflowConfig = {
  ...
  transitions: {
    ...
    [t('pending', 'cancelled')]: { label: 'Cancel', intent: 'danger' },
    [t('in_progress', 'shipped')]: { label: 'Mark Shipped', intent: 'primary' },
    [t('in_progress', 'cancelled')]: { label: 'Cancel', intent: 'danger' },
    [t('shipped', 'delivered')]: { label: 'Mark Delivered', intent: 'success' },
