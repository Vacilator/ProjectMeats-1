...
export interface USState {
  value: string;  // 2-letter abbreviation
...
/**
 * Get state label by abbreviation
 */
...
/**
 * Validate if a string is a valid US state abbreviation
 */
export const isValidStateAbbreviation = (value: string): boolean => {
  return US_STATES.some(s => s.value === value.toUpperCase());
};
