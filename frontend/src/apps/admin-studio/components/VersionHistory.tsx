...
export const VersionHistory: React.FC<VersionHistoryProps> = ({
  ...
  const fetchVersionHistory = useCallback(async () => {
    ...
    try {
      ...
      logger.error('Failed to fetch version history', { component: 'VersionHistory' }, error);
    } finally {
      setLoading(false);
    }
  }, [blueprintId]);
  ...
  const handleRollback = async (versionId: string, versionNumber: number) => {
    ...
    try {
      ...
      logger.error('Rollback failed', { component: 'VersionHistory' }, error);
      showAlert({
  ...
  const handleCompare = async (versionBId: string) => {
    ...
    try {
      ...
      logger.error('Comparison failed', { component: 'VersionHistory' }, error);
      showAlert({
