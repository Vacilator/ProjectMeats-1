...
export const TenantConfigEditor: React.FC<TenantConfigEditorProps> = ({ onClose }) => {
  ...
  const loadConfigs = useCallback(async () => {
    try {
      ...
      logger.error('Error loading configs', { component: 'TenantConfigEditor' }, err);
  ...
  const handleDeleteConfig = async (index: number) => {
    ...
    if (config.id) {
      ...
      try {
        ...
        logger.error('Error deleting config', { component: 'TenantConfigEditor' }, err);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      logger.error('Error saving configs', { component: 'TenantConfigEditor' }, err);
  ...
  const handleImport = () => {
    ...
    input.onchange = async (e) => {
      ...
      try {
        ...
        logger.error('Import error', { component: 'TenantConfigEditor' }, err);
