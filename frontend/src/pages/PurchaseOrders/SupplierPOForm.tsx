...
import { apiService, type Supplier, type PurchaseOrder } from '@/services/apiService';
    ...
    async (status: 'draft' | 'pending') => {
      ...
      try {
        ...
        if (mode === 'edit' && entityId) {
          await apiService.updatePurchaseOrder(Number(entityId), payload as Partial<PurchaseOrder>);
        } else {
          await apiService.createPurchaseOrder(payload as Partial<PurchaseOrder>);
        }
        message.success(
