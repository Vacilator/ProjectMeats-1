...
| **Settlement reconciliation contract** | `docs/runbooks/SETTLEMENT_RECONCILIATION.md`, `backend/tenant_apps/integrations/settlement_contract.py`, `backend/tenant_apps/invoices/models.py` | AUTHORITATIVE |
| **B2B extranet portal contract** | `docs/runbooks/B2B_EXTRANET_PORTAL.md`, `backend/apps/core/security.py` | AUTHORITATIVE |
